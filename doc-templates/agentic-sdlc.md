...
Este documento descreve o fluxo de trabalho de desenvolvimento ponta a ponta assistido por agentes de Inteligência Artificial. O objetivo é automatizar tarefas repetitivas de planejamento, escrita de código, versionamento e revisão, garantindo consistência técnica em todas as variações arquiteturais.
